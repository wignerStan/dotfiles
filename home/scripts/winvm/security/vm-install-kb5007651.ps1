$log = "C:\Users\jacob\Downloads\install-kb5007651-log.txt"
...
$dst = "C:\Users\jacob\Downloads\SecurityHealthSetup.exe"
...
} catch { W "download fail: $($_.Exception.Message)"; "FAIL" | Out-File "C:\Users\jacob\Downloads\kb-dl-failed.flag"; exit 1 }
