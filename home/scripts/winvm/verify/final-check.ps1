$log = 'C:\Users\jacob\finalcheck-log.txt'
...
W ("git: {0}" -f [bool](Test-Path 'C:\Users\jacob\.local\mingit\cmd\git.exe'))
W ("uv: {0}" -f [bool](Test-Path 'C:\Users\jacob\.local\uv\uv.exe'))
W ("python aarch64: {0}" -f [bool](Get-ChildItem 'C:\Users\jacob\AppData\Roaming\uv\python' -Directory -Filter '*aarch64*' -EA SilentlyContinue))
W ("7z: {0}" -f (Test-Path 'C:\Users\jacob\AppData\Local\7-Zip\7z.exe'))
W ("geek: {0}" -f (Test-Path 'C:\Users\jacob\AppData\Local\GeekUninstaller\geek.exe'))
