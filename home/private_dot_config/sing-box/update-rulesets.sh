...
declare -A RULESETS=(
  ...
  ["geosite-anthropic.srs"]="SagerNet/sing-geosite/rule-set/geosite-anthropic.srs"
  ["geosite-perplexity.srs"]="SagerNet/sing-geosite/rule-set/geosite-perplexity.srs"
  ["geosite-cursor.srs"]="SagerNet/sing-geosite/rule-set/geosite-cursor.srs"
  ["geosite-poe.srs"]="SagerNet/sing-geosite/rule-set/geosite-poe.srs"
